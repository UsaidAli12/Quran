...
export default function Chat({navigation}) {
  ...
  const msgs = [[{key:0,msg:'Hello how are you', time:'11:00 PM'},{key:1,msg:' Huzaifa here',time:'11:07 PM'}],
                [{key:0,msg:'Are you free ?', time:'6:20 PM'},{key:1,msg:'I need to talk to you', time:'6:22 PM'}],
                [{key:0,msg:'Ajao chaleen', time:'11:02 PM'},],
                [{key:0,msg:'Namaz parho ', time:'5:42 PM'},{key:1,msg:'😥😥',time:'5:43 PM'}],
                [],
                [{key:0,msg:'kidhr ho bhai?', time:'1:22 PM'},],
                [{key:0,msg:'Okay ! see you then', time:'4:54 AM'},],
                [],
                [{key:0,msg:'Kidhr ho?', time:'3:12 AM'},{key:1,msg:'Listen', time:'5:02 AM'}],
                [{key:0,msg:'ki haal ustaad g?', time:'11:02 PM'},],
                [{key:0,msg:'That was a pleasent experience', time:'1:22 AM'},{key:1,msg:'I need to talk to you', time:'2:09 PM'}],
                [{key:0,msg:'Hello sherry kesy ho ?', time:'11:02 PM'},],
  ...
  const [data, setData] = useState([
    ...
    {key:6, title:'Ali Afzal', msg:msgs[6], unread:msgs[6].length,src: require("../assets/users/dummy.jpg")},
    {key:7, title:'Maryam', msg:msgs[7], unread:msgs[7].length,src: require("../assets/users/dummy.jpg")},
    {key:8, title:'Minahil', msg:msgs[8], unread:msgs[8].length,src: require("../assets/users/i1.jpg")},
    {key:9, title:'Huzaifa', msg:msgs[9], unread:msgs[9].length ,src: require("../assets/users/i1.jpg")},
    {key:10, title:'Sara', msg:msgs[10], unread:msgs[10].length,src: require("../assets/users/dummy.jpg")},
    {key:11, title:'Aleem ❤️❤️❤️', msg:msgs[11],unread: msgs[11].length,src: require("../assets/users/i2.jpg")},
  ]);
